...
const Footer = () => {
  ...
  return (
     <div className='w-full h-20 bg-emerald-700 flex items-center justify-between px-5 absolute bottom-0'>
       <h1 className='text-2xl font-semibold text-zinc-800'>Footer</h1>
